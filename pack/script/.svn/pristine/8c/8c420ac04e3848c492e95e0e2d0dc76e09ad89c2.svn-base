require "script/cocos2dx/CocoStudio"
...
cc.md5 = {}
function cc.md5.string(str)
    return cc.Application:getInstance():md5String(str)
end
function cc.md5.file(file)
    return cc.Application:getInstance():md5File(file)
end
local ConfigType = 
{
    NONE = 0,
